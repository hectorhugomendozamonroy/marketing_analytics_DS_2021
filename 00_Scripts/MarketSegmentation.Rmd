...
We can now read the raw data (Provide the appropiate directory!!!!): 

```{r,eval=TRUE,echo=TRUE}
seg_data <- read_csv(file = "/Documents and Settings/Admin/Documents/Business_Science/marketing_analytics_DS_2021/00_Data/SegmentationData.csv")
head(seg_data)
```
